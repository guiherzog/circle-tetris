...
document.addEventListener("DOMContentLoaded", function()
{
	...
	if (highscores == null)
	{
		...
		li_highscore[i].innerHTML = "<h3 align='center' id='name'>No highscore...</h3><p align='center'><br>You can't become the Circle Master without playing!</p><div class='line-separator'></div>";
	}
